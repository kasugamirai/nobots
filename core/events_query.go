...
func (eq *EventsQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (eq *EventsQuery) FirstIDX(ctx context.Context) int64 {
...
func (eq *EventsQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (eq *EventsQuery) OnlyIDX(ctx context.Context) int64 {
...
func (eq *EventsQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (eq *EventsQuery) IDsX(ctx context.Context) []int64 {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (eq *EventsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Events, error) {
	...
	_spec.Node.Schema = eq.schemaConfig.Events
...
func (eq *EventsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(events.Table, events.Columns, sqlgraph.NewFieldSpec(events.FieldID, field.TypeInt64))
	_spec.From = eq.sql
...
func (eq *EventsQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(eq.schemaConfig.Events)
	ctx = internal.NewSchemaConfigContext(ctx, eq.schemaConfig)
