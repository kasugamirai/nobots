...
type SchemaConfig struct {
	BotEvents                string // BotEvents table.
	Events                   string // Events table.
	NostrNotesFetchHistory   string // NostrNotesFetchHistory table.
	TwitterFetchHistory      string // TwitterFetchHistory table.
	TwitterNote              string // TwitterNote table.
	TwitterNotesFetchHistory string // TwitterNotesFetchHistory table.
	TwitterProfile           string // TwitterProfile table.
}
